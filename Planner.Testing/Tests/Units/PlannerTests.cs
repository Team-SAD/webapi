...
namespace Planner.Testing
{
  public class PlannerTests
  {
    ...
    {
      new object[] { new AppUser(){Name = "Rebecca Algoeth"}},
      new object[] { new AppUser(){Name = "Ash Ketyup"}},
      new object[] { new AppUser(){Name = "Megodola Euimun"}}
    };
    ...
    public void PlannerTestCustomers(AppUser cs)
    {
      Plan planner = new Plan();
      planner.Customer = cs;
      Assert.NotNull(planner.Customer);
